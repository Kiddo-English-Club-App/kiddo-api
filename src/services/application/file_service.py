...
class File:
    """
    File class to represent a file with name, content and mime_type attributes.
    """
...
class FileService:
    """
    File service interface to define the methods for working with files.

    The get_file method should return a File object for the given file name.
    """
